...
class TestAuthentication:
    ...
    def test_register_duplicate_email_fails(self, client, service_urls, registered_user):
...
class TestInventory:
    ...
    def test_seed_inventory_success(self, client, service_urls, auth_headers, sample_skus):
    ...
    def test_get_inventory_success(self, client, service_urls, auth_headers, sample_skus):
...
class TestOrders:
    ...
    def test_create_order_success(self, client, service_urls, auth_headers, sample_skus):
    ...
    def test_create_order_multiple_items(self, client, service_urls, auth_headers, sample_skus):
...
class TestE2EFlow:
    ...
    def test_order_flow_from_writer_service(self, client, service_urls, auth_headers, sample_skus):
